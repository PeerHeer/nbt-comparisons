...
execute store success score #nbtcomp.typeid.success nbtcomp.var store success score #nbtcomp.typeid.success0 nbtcomp.var run data modify storage nbtcomp:typeid.cache Entry[0].List append from storage nbtcomp:typeid.args Data
execute unless score #nbtcomp.typeid.success0 nbtcomp.var matches 1 store success score #nbtcomp.typeid.success nbtcomp.var store success score #nbtcomp.typeid.success1 nbtcomp.var run data modify storage nbtcomp:typeid.cache Entry[1].List append from storage nbtcomp:typeid.args Data
