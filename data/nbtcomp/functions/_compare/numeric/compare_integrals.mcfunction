...
execute if score #nbtcomp.compare.result nbtcomp.var matches 0 if score #typeid.type_id typeid.var matches 5..6 run function nbtcomp:types/numeric/float/get_float_fraction
