...
# Compare integrals
execute if score #typeid.type_id typeid.var matches 1..6 run function nbtcomp:_compare/numeric/compare_integrals
# Compare lengths
execute if score #typeid.type_id typeid.var matches 7..12 run function nbtcomp:_compare/generic/compare_lengths
...
execute if score #nbtcomp.compare.result nbtcomp.var matches 0 if score #typeid.type_id typeid.var matches 5..6 run function nbtcomp:_compare/numeric/compare_fractions